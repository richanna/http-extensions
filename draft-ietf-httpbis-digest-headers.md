...
Protecting with a signature the `Digest` field of a request which has no payload body
ensures that an eventual payload has not been stripped off nor been added.
